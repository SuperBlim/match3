...
function PlayState:calculateMatches()
    ...
    if matches then
        ...
        Timer.tween(math.random(0.001,9), tilesToFall):finish(function()
...
function PlayState:render()
    ...
    love.graphics.printf('AMOGUS: ' .. tostring(self.level), 20, 24, 182, 'center')
    love.graphics.printf('FIRE IN THE HOLE: ' .. tostring(self.score), 20, 52, 182, 'center')
    love.graphics.printf('WATER ON THE HILL : ' .. tostring(self.scoreGoal), 20, 80, 182, 'center')
    love.graphics.printf('1-00: ' .. tostring(math.random(1,2)), 20, 108, 182, 'center')
end